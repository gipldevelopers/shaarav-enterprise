      ...
      <section className="relative pt-40 pb-24 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative max-w-4xl">
          ...
          <h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-semibold leading-[1.05] mb-6">
            Six continents.
            <br />
            <span className="text-gradient-gold italic">One promise.</span>
          </h1>
          <p className="text-lg text-foreground/80 max-w-2xl">
            From the spice belt of India to your warehouse — wherever in the world that may be.
          </p>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="container mx-auto px-6">
          <SectionHeading
            ...
            title={
              <>
                Where we <span className="text-gradient-gold italic">deliver</span>
              </>
            }
          />
      ...
      <section className="py-24 bg-card/30">
        <div className="container mx-auto px-6">
          <SectionHeading
            ...
            title={
              <>
                How we <span className="text-gradient-gold italic">deliver</span>
              </>
            }
            subtitle="A multi-modal logistics network engineered for speed, safety and flexibility."
          />
            ...
            {[
              {
                icon: Ship,
                t: "Sea Freight",
                d: "FCL & LCL out of Mundra, Nhava Sheva, Cochin & Chennai. 21–35 day transit.",
              },
              {
                icon: Plane,
                t: "Air Cargo",
                d: "Express premium shipments via Mumbai & Delhi. 3–7 day delivery worldwide.",
              },
              {
                icon: Truck,
                t: "Last Mile",
                d: "Bonded warehouse partnerships in 12 cities for door-step delivery.",
              },
            ].map((s) => (
        ...
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="font-display text-4xl md:text-5xl mb-6">
              Paperwork, <span className="text-gradient-gold italic">handled.</span>
            </h2>
            <p className="text-muted-foreground text-lg mb-6 leading-relaxed">
              Customs, certificates, and country-specific compliance — our export team manages every
              form so your shipment clears without delays.
            </p>
      ...
      <section className="py-24 bg-card/30">
        <div className="container mx-auto px-6">
          <SectionHeading
            ...
            title={
              <>
                Local <span className="text-gradient-gold italic">presence</span>
              </>
            }
          />
      ...
      <section className="py-24">
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="font-display text-4xl md:text-5xl mb-6">
              On time, <span className="text-gradient-gold italic">every time.</span>
            </h2>
      ...
      <section className="py-24 text-center bg-card/30">
        <div className="container mx-auto px-6 max-w-3xl">
          <h2 className="font-display text-4xl md:text-6xl mb-6">
            Ship to <span className="text-gradient-gold italic">your country.</span>
          </h2>
          <p className="text-muted-foreground text-lg mb-8">
            Tell us where you're based and we'll handle the rest.
          </p>
          <Link
            to="/contact"
