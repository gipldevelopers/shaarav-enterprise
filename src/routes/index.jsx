    ...
    <div>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        <div className="absolute inset-0">
          ...
          >
            <source
              src="https://cdn.coverr.co/videos/coverr-cooking-with-spices-2649/1080p.mp4"
              type="video/mp4"
            />
          </video>
          <img
        ...
        <div className="container mx-auto px-6 relative z-10 py-20">
          <div className="max-w-4xl reveal">
            ...
            <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-semibold leading-[1.05] mb-6">
              Where <span className="text-gradient-gold italic">Quality</span>
              <br />
            ...
            <p className="text-base md:text-lg text-muted-foreground max-w-2xl mb-8 leading-relaxed">
              From sun-drenched farms of India to the world's most discerning kitchens — premium
              whole and powdered spices, sourced ethically, processed meticulously.
            </p>
            <div className="flex flex-wrap gap-4 mb-12">
              <Link
                to="/products"
                className="group inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-gold text-primary-foreground font-semibold shadow-luxury hover:scale-105 transition-transform"
              >
                Discover Our Range{" "}
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-full glass text-foreground font-semibold hover:bg-primary/10 transition"
              >
                Request Catalog
              </Link>
            </div>
      ...
      <section className="border-y border-border bg-secondary/30 py-10 overflow-hidden">
        ...
        <div className="flex gap-16 animate-shimmer whitespace-nowrap">
          {[
            ...
            <span
              key={b}
              className="font-display text-2xl md:text-3xl text-muted-foreground/60 tracking-widest"
            >
              {b}
            </span>
          ))}
        ...
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="font-display text-3xl md:text-5xl font-semibold leading-tight mb-4">
              Pure Flavors.
              <br />
              <span className="text-gradient-gold italic">Global Reach.</span>
            </h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              At Shaarav Global Ventures, we believe quality spices are the soul of every kitchen.
              Founded with a vision to bring India's rich legacy to every corner of the globe, we
              specialize in the export of premium whole and powdered spices.
            </p>
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              We source directly from trusted farmers and processing units, ensuring only the finest
              products reach our clients — with uncompromising commitment to purity, freshness, and
              authenticity.
            </p>
            ...
            <Link
              to="/about"
              className="inline-flex items-center gap-2 text-primary font-semibold hover:gap-4 transition-all text-sm"
            >
        ...
        <div className="container mx-auto px-6 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="font-display text-2xl md:text-4xl leading-tight mb-8">
              "To deliver the{" "}
              <span className="text-gradient-gold italic">authentic taste of India</span> to
              kitchens across the globe — empowering local farmers, delighting global consumers, and
              ...
              {[
                {
                  n: "01",
                  t: "Source",
                  d: "Direct partnerships with farmer cooperatives across India's spice belt.",
                },
                {
                  n: "02",
                  t: "Process",
                  d: "State-of-the-art facilities with rigorous quality controls and lab testing.",
                },
                {
                  n: "03",
                  t: "Deliver",
                  d: "Reliable global logistics, transparent documentation, on-time always.",
                },
              ].map((s) => (
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          <SectionHeading
            ...
            title={
              <>
                Whole <span className="text-gradient-gold italic">Spices</span>
              </>
            }
            subtitle="Handpicked, sun-cured, and exported in their most natural form to preserve every essential note."
          />
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div
                key={p.n}
                className="group relative aspect-[3/4] rounded-2xl overflow-hidden hover-lift cursor-pointer border border-border"
              >
                <img
                  src={p.img}
                  alt={p.n}
        ...
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Our cold-grinding process locks in essential oils and aroma. Every powdered spice
              retains its vibrant color, full potency, and authentic character — exactly as nature
              intended.
            </p>
            <ul className="space-y-3 mb-6">
              {[
                "Cold-ground to preserve volatile oils",
                "Steam sterilized for microbial safety",
                "Custom mesh sizes available",
                "Bulk & retail-ready packaging",
              ].map((t) => (
            ...
            <div className="grid grid-cols-3 gap-3">
              {["Turmeric", "Red Chili", "Coriander", "Cumin", "Garam Masala", "Curry Powder"].map(
                (s) => (
                  <div
                    key={s}
                    className="glass rounded-xl px-3 py-2 text-xs text-center font-medium"
                  >
                    {s}
                  </div>
                ),
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          <SectionHeading
            ...
            title={
              <>
                The <span className="text-gradient-gold italic">Shaarav</span> Process
              </>
            }
            subtitle="Every spice on your shelf has travelled a meticulous path. Here's how we guarantee its journey."
          />
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              {
                icon: Leaf,
                t: "Cultivation",
                d: "Partner farms across India's spice regions following sustainable practices.",
                img: farmers,
              },
              {
                icon: Package,
                t: "Harvesting",
                d: "Hand-picked at peak ripeness, sun-cured the traditional way.",
                img: cardamomHands,
              },
              {
                icon: Factory,
                t: "Processing",
                d: "Cleaned, sorted, ground, and sterilized in modern facilities.",
                img: facility,
              },
              {
                icon: Truck,
                t: "Export",
                d: "Vacuum sealed, certified, and shipped to your doorstep worldwide.",
                img: globeImg,
              },
            ].map((s, i) => (
              <div key={s.t} className="group">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden mb-4 relative border border-border">
                  <img
                    ...
                    height={896}
                  />
                  <div className="absolute top-3 left-3 w-8 h-8 rounded-full bg-gradient-gold flex items-center justify-center font-display font-bold text-primary-foreground text-sm">
                    {i + 1}
                  </div>
                </div>
      ...
      <section className="relative py-16 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative">
          <SectionHeading
            ...
            title={
              <>
                Built on <span className="text-gradient-gold italic">six pillars</span>
              </>
            }
            subtitle="What separates Shaarav from the ordinary spice trader."
          />
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              {
                icon: ShieldCheck,
                t: "Uncompromising Purity",
                d: "Zero adulteration. Every shipment lab-tested and certified to international standards.",
              },
              {
                icon: Leaf,
                t: "Ethical Sourcing",
                d: "Fair pricing for farmers, transparent supply chains, and sustainable agriculture.",
              },
              {
                icon: Award,
                t: "Award-Winning Quality",
                d: "Recognized by leading export councils and trusted across continents.",
              },
              {
                icon: Truck,
                t: "On-Time Logistics",
                d: "Reliable global shipping with full documentation and tracking.",
              },
              {
                icon: Sparkles,
                t: "Custom Blends",
                d: "Private label, custom formulations, and packaging tailored to your brand.",
              },
              {
                icon: Users,
                t: "Dedicated Support",
                d: "A personal account manager for every client, every shipment.",
              },
            ].map((c) => (
      ...
      <section className="py-16">
        <div className="container mx-auto px-6 grid lg:grid-cols-5 gap-12 items-center">
          ...
          <div className="lg:col-span-3">
            ...
            <h2 className="font-display text-3xl md:text-5xl font-semibold leading-tight mb-4">
              Kashmiri <span className="text-gradient-gold italic">Saffron</span> — pound for pound,
              the world's most precious spice.
            </h2>
            <p className="text-muted-foreground leading-relaxed mb-6">
              Sourced from the high meadows of Pampore, our Mongra grade saffron is hand-harvested
              from the autumn crocus, sorted thread-by-thread, and graded to international ISO 3632
              Category I.
            </p>
      ...
      <section className="py-16 relative bg-secondary/20">
        <div className="container mx-auto px-6">
          <SectionHeading
            ...
            title={
              <>
                Exporting to <span className="text-gradient-gold italic">40+ countries</span>
              </>
            }
            subtitle="From the spice hubs of India to kitchens, restaurants, and retailers across six continents."
          />
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          <SectionHeading
            ...
            title={
              <>
                Certified, audited, <span className="text-gradient-gold italic">verified.</span>
              </>
            }
            subtitle="Compliance with the world's most rigorous food safety and quality standards."
          />
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {["ISO 22000", "FSSAI", "HACCP", "FDA", "APEDA", "ORGANIC"].map((c) => (
              <div
                key={c}
                className="aspect-square glass rounded-2xl flex flex-col items-center justify-center hover-lift p-3"
              >
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              {
                n: "Marco Rossi",
                r: "Procurement Head, Aroma & Co. (Italy)",
                t: "Shaarav has transformed our spice supply chain. The consistency in aroma and color, batch after batch, is simply unmatched.",
              },
              {
                n: "Priya Nair",
                r: "Founder, Spice Route Café (UK)",
                t: "Their Kashmiri saffron is the gold standard. Our customers can taste the difference, and so can we.",
              },
              {
                n: "Hiroshi Tanaka",
                r: "Director, Oriental Foods (Japan)",
                t: "Reliable, transparent, and always on time. Working with Shaarav feels like a true partnership, not a transaction.",
              },
            ].map((t) => (
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          <SectionHeading
            ...
            title={
              <>
                The Shaarav <span className="text-gradient-gold italic">gallery</span>
              </>
            }
            subtitle="A glimpse into the world of premium spices — from harvest to packaging."
          />
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[hero, farmers, facility, powders, whole, saffron, cardamomHands, jars].map(
              (src, i) => (
                <div
                  key={i}
                  className={`relative overflow-hidden rounded-2xl border border-border ${i % 3 === 0 ? "row-span-2 aspect-[3/4]" : "aspect-square"} hover-lift group`}
                >
                  <img
                    src={src}
                    alt={`Gallery ${i + 1}`}
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative text-center max-w-3xl">
          ...
          <h2 className="font-display text-4xl md:text-6xl lg:text-7xl font-semibold leading-tight mb-6">
            Bring authentic <span className="text-gradient-gold italic">Indian spices</span> to your
            shelves.
          </h2>
          <p className="text-muted-foreground text-lg mb-10">
            Whether you're a distributor, retailer, or chef — partner with Shaarav for spices the
            world keeps coming back for.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link
              to="/products"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-full glass font-semibold hover:bg-primary/10 transition"
            >
