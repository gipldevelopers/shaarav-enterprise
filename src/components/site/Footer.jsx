        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6">
              Bringing the authentic taste of India to kitchens around the world through premium
              spice exports rooted in tradition and quality.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              {[
                ...
                <li key={p} className="hover:text-primary transition cursor-pointer">
                  {p}
                </li>
              ))}
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-muted-foreground">
              <li className="flex gap-3">
                ...
                <span>Plot 12, Spice Park, Kandla SEZ, Gujarat 370230, India</span>
              </li>
              <li className="flex gap-3">
              ...
              <li className="flex gap-3">
                ...
                <span>export@shaaravglobal.com</span>
              </li>
            </ul>
          </div>
        </div>
